                ...
                <div className="text-center max-w-md mx-auto p-8">
                  ...
                  <div className="grid gap-4 text-left">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-card border border-border">
                      ...
                      <div>
                        <h4 className="font-medium text-foreground">Estratégias de Investimento</h4>
                        <p className="text-sm text-muted-foreground">Ações, fundos, renda fixa e mais</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-card border border-border">
                      ...
                      <div>
                        <h4 className="font-medium text-foreground">Análise de Mercado</h4>
                        <p className="text-sm text-muted-foreground">Tendências e oportunidades</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-card border border-border">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Metas e objetivos pessoais</p>
                      </div>
                    </div>
                  </div>
